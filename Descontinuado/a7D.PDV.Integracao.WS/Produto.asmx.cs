    ...
    public class Produto : System.Web.Services.WebService
    {
        ...
        public String ListarProdutos(DateTime dtUltimaVerificacao)
        {
            ...
            try
            {
                ...
                List<ProdutoInformation> lista = BLL.Produto.ListarAtivosDAL(dtUltimaVerificacao).OrderBy(l => l.Nome).Where(p => p.TipoProduto.IDTipoProduto != 40).ToList();
        ...
        public String ListarDisponibilidadeProdutos(DateTime dtUltimaVerificacao)
        {
            ...
            try
            {
                List<ProdutoInformation> lista = BLL.Produto.Listar().Where(l => l.DtAlteracaoDisponibilidade >= dtUltimaVerificacao.AddMilliseconds(-500)).ToList();
