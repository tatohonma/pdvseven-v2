...
export const FATURA_RQ = 'FATURA_RQ'
export const FATURA_SC = 'FATURA_SC'
export const FATURA_ER = 'FATURA_ER'

export const NOVOBOLETO_RQ = 'NOVOBOLETO_RQ'
export const NOVOBOLETO_SC = 'NOVOBOLETO_SC'
export const NOVOBOLETO_ER = 'NOVOBOLETO_ER'
export const NOVOBOLETO_CL = 'NOVOBOLETO_CL'
...
export function obterFaturas (id) {
  return {
    [CALL_API]: {
      types: [ FATURA_RQ, FATURA_SC, FATURA_ER ],
      schema: Schemas.FATURA_ARRAY,
      endpoint: `faturas?id=${id}`
    }
  }
}
...
export function gerarNovoBoleto (idFatura) {
  return {
    [CALL_API]: {
      types: [NOVOBOLETO_RQ, NOVOBOLETO_SC, NOVOBOLETO_ER],
      schema: Schemas.FATURA,
      endpoint: `boleto/${idFatura}`
    }
  }
}

export function limparBoleto () {
  return {
    type: NOVOBOLETO_CL
  }
}