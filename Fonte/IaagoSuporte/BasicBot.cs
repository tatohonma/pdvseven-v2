...
namespace Microsoft.BotBuilderSamples
{
    ...
    public class BasicBot : IBot
    {
        ...
        /// </summary>
        public static readonly string LuisConfiguration = "Suporte2";
        ...
        public async Task OnTurnAsync(ITurnContext turnContext, CancellationToken cancellationToken)
        {
            ...
            if (activity.Type == ActivityTypes.Message)
            {
                ...
                {
                    await dc.Context.SendActivityAsync(ex.Body.Message);
                    return;
                }
                        ...
                        case DialogTurnStatus.Empty:
                            switch (topIntent)
                            {
                                ...
                                case NoneIntent:
                                    ...
                                    // to the user
                                    await dc.Context.SendActivityAsync("Não entendi!");
                                    break;

                                default:
                                    await dc.Context.SendActivityAsync("Sobre: " + topIntent);
                                    break;
                            }
