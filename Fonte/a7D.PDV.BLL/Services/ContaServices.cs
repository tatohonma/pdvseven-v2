...
namespace a7D.PDV.BLL.Services
{
    public static class ContaServices
    {
        ...
        public static void ImprimirConta(string nomeImpressoraWindows, PedidoInformation pedido)
        {
            ...
            if (contaCliente)
                ImpressoraWindows.Imprimir(nomeImpressoraWindows, (s, a) => ImprimirTicketPix(s, a, pedido));
        ...
        public static void ImprimirTicketPix(object sender, PrintPageEventArgs e, PedidoInformation pedido)
        {
            ...
            var dados = "http://wwww.pdvseven.com.br";

            Bitmap qrCodeImage = qrcodeEncoder.Encode(dados);
